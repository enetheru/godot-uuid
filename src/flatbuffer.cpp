...
int64_t FlatBuffer::get_field_offset( const int64_t vtable_pos ) const {
  ...
  if( vtable_pos >= vtable_size ) { return 0; }
...
godot::Variant FlatBuffer::decode_variant(int64_t start, const godot::Variant::Type expected_type) const {
  // TODO format the string below to show the types.
  ERR_FAIL_COND_V_MSG(expected_type == godot::Variant::Type::VARIANT_MAX, nullptr,
    "An expected type is required." );
  ...
  switch( expected_type ) {
    ...
    case godot::Variant::STRING: {
      ...
      start += sizeof( uint32_t );
      return fb_bytes->slice( start, start + string_size )
          .get_string_from_utf8();
    }
    case godot::Variant::VECTOR2:     return decode_gtype2<godot::Vector2>(fb_bytes, start );
    case godot::Variant::VECTOR2I:    return decode_gtype2<godot::Vector2i>(fb_bytes, start );
    case godot::Variant::RECT2:       return decode_gtype2<godot::Rect2>(fb_bytes, start );
    case godot::Variant::RECT2I:      return decode_gtype2<godot::Rect2i>(fb_bytes, start );
    case godot::Variant::VECTOR3:     return decode_gtype2<godot::Vector3>(fb_bytes, start );
    case godot::Variant::VECTOR3I:    return decode_gtype2<godot::Vector3i>(fb_bytes, start );
    case godot::Variant::TRANSFORM2D: return decode_gtype2<godot::Transform2D>(fb_bytes, start );
    case godot::Variant::VECTOR4:     return decode_gtype2<godot::Vector4>(fb_bytes, start );
    case godot::Variant::VECTOR4I:    return decode_gtype2<godot::Vector4i>(fb_bytes, start );
    case godot::Variant::PLANE:       return decode_gtype2<godot::Plane>(fb_bytes, start );
    case godot::Variant::QUATERNION:  return decode_gtype2<godot::Quaternion>(fb_bytes, start );
    case godot::Variant::AABB:        return decode_gtype2<godot::AABB>(fb_bytes, start );
    case godot::Variant::BASIS:       return decode_gtype2<godot::Basis>(fb_bytes, start );
    case godot::Variant::TRANSFORM3D: return decode_gtype2<godot::Transform3D>(fb_bytes, start );
    case godot::Variant::PROJECTION:  return decode_gtype2<godot::Projection>(fb_bytes, start );
    case godot::Variant::COLOR:       return decode_gtype2<godot::Color>(fb_bytes, start );
    case godot::Variant::STRING_NAME:{
      const uint32_t string_size = fb_bytes->decode_u32( start );
      start += sizeof( uint32_t );
      const godot::String string = fb_bytes->slice( start, start + string_size )
          .get_string_from_utf8();
